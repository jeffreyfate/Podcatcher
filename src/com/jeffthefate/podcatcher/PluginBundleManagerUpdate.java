...
public final class PluginBundleManagerUpdate
{
    /**
    ...
    public static boolean isBundleValid(final Bundle bundle)
    {
         ...
         */
        if (!bundle.containsKey(Constants.BUNDLE_EXTRA_INT_UPDATE)) {
            Log.e(Constants.LOG_TAG,
                  String.format("bundle must contain extra %s",
                          Constants.BUNDLE_EXTRA_INT_UPDATE)); //$NON-NLS-1$
            return false;
        }
        ...
        if (bundle.getInt(Constants.BUNDLE_EXTRA_INT_UPDATE, 0) !=
            bundle.getInt(Constants.BUNDLE_EXTRA_INT_UPDATE, 1)) {
            Log.e(Constants.LOG_TAG,
    ...
    public static Bundle generateBundle(final Context context, final int mode) {
        ...
        result.putInt(Constants.BUNDLE_EXTRA_INT_UPDATE, mode);
     ...
     */
    private PluginBundleManagerUpdate() {

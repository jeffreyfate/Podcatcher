...
public class MediaButtonHelper {
    ...
    static void initializeStaticCompatMethods() {
        try {
            sMethodRegisterMediaButtonEventReceiver = 
                AudioManager.class.getMethod(Constants.REGISTER_MEDIA_BUTTON,
                    new Class[] { ComponentName.class });
            sMethodUnregisterMediaButtonEventReceiver = 
                AudioManager.class.getMethod(Constants.UNREGISTER_MEDIA_BUTTON,
                    new Class[] { ComponentName.class });
    ...
    public static void registerMediaButtonEventReceiverCompat(
        ...
        try {
            ...
            Log.e(Constants.LOG_TAG, "IllegalAccessException invoking " +

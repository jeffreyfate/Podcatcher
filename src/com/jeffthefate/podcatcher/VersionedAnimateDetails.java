...
public abstract class VersionedAnimateDetails {
    ...
    public abstract VersionedAnimateDetails create(
            ...
            RelativeLayout episodeDetailsLayout, ImageView more);
    ...
    private static class GingerbreadAnimateDetails extends
        ...
        public boolean animate() {
            ...
            final AlphaAnimation moreAnim = new AlphaAnimation(0.0f, 0.5f);
            moreAnim.setDuration(50);
            moreAnim.setInterpolator(new LinearInterpolator());
        ...
        public boolean unanimate() {
            ...
            final AlphaAnimation moreAnim = new AlphaAnimation(0.5f, 0.0f);
            moreAnim.setDuration(50);
            moreAnim.setInterpolator(new LinearInterpolator());
            more.startAnimation(moreAnim);
    ...
    private static class HoneycombAnimateDetails extends
        ...
        public boolean animate() {
            final ValueAnimator epDetailsAnim = ObjectAnimator.ofFloat(
                    episodeDetailsLayout, Constants.ALPHA, 0.0f, 1.0f);
            ...
            final ValueAnimator moreAnim = ObjectAnimator.ofFloat(more,
                    Constants.ALPHA, 0.0f, 0.5f);
            moreAnim.setDuration(50);
            moreAnim.setInterpolator(new LinearInterpolator());
            ValueAnimator imageAnimX = ObjectAnimator.ofFloat(feedImage,
                    Constants.SCALE_X, 0.5f);
            ...
            ValueAnimator imageAnimY = ObjectAnimator.ofFloat(feedImage,
                    Constants.SCALE_Y, 0.5f);
            ...
            ValueAnimator progressAnimFade = ObjectAnimator.ofFloat(progressLayout,
                    Constants.ALPHA, 1.0f, 0.0f);
            progressAnimFade.setDuration(100);
            progressAnimFade.setInterpolator(new LinearInterpolator());
            ValueAnimator timeAnimFade = ObjectAnimator.ofFloat(timeLayout,
                    Constants.ALPHA, 0.0f, 1.0f);
            ...
            ValueAnimator skipAnimFade = ObjectAnimator.ofFloat(skipButton,
                    Constants.ALPHA, 0.0f, 1.0f);
            ...
            ValueAnimator seekAnimFade = ObjectAnimator.ofFloat(seekBar,
                    Constants.ALPHA, 0.0f, 1.0f);
        ...
        public boolean unanimate() {
            ValueAnimator imageAnimX = ObjectAnimator.ofFloat(feedImage,
                    Constants.SCALE_X, 1.0f);
            imageAnimX.setDuration(100);
            imageAnimX.setInterpolator(new LinearInterpolator());
            ValueAnimator imageAnimY = ObjectAnimator.ofFloat(feedImage,
                    Constants.SCALE_Y, 1.0f);
            imageAnimY.setDuration(100);
            imageAnimY.setInterpolator(new LinearInterpolator());
            ValueAnimator progressAnimFade = ObjectAnimator.ofFloat(progressLayout,
                    Constants.ALPHA, 0.0f, 1.0f);
            ...
            ValueAnimator epDetailsAnim = ObjectAnimator.ofFloat(
                    episodeDetailsLayout, Constants.ALPHA, 1.0f, 0.0f);
            epDetailsAnim.setDuration(50);
            epDetailsAnim.setInterpolator(new LinearInterpolator());
            epDetailsAnim.addListener(new AnimatorListenerAdapter() {
                @Override

...
public final class PluginBundleManagerSwipe
{
    /**
    ...
    public static boolean isBundleValid(final Bundle bundle)
    {
         ...
         */
        if (!bundle.containsKey(Constants.BUNDLE_EXTRA_BOOLEAN_SWIPE)) {
            Log.e(Constants.LOG_TAG,
                  String.format("bundle must contain extra %s",
                          Constants.BUNDLE_EXTRA_BOOLEAN_SWIPE)); //$NON-NLS-1$
            return false;
        }
        ...
        if (bundle.getBoolean(Constants.BUNDLE_EXTRA_BOOLEAN_SWIPE, false) !=
            bundle.getBoolean(Constants.BUNDLE_EXTRA_BOOLEAN_SWIPE, true)) {
            Log.e(Constants.LOG_TAG,
                    String.format("bundle extra %s appears to be the wrong " +
                            "type.  It must be a boolean",
                            Constants.BUNDLE_EXTRA_BOOLEAN_SWIPE));
            return false;
        }
    ...
    public static Bundle generateBundle(final Context context,
        ...
        result.putBoolean(Constants.BUNDLE_EXTRA_BOOLEAN_SWIPE, mode);
     ...
     */
    private PluginBundleManagerSwipe() {
